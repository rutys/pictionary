...
//                           colorpicker
// ================================================
    angular.module('mean.socket').factory('Helper', function () {
        'use strict';
        return {
    ...
    angular.module('mean.socket').factory('Color', ['Helper', function (Helper) {
        'use strict';
        return {
            value: {
                h: 1,
    ...
    angular.module('mean.socket').factory('Slider', ['Helper', function (Helper) {
        'use strict';
        var
            slider = {
                maxLeft: 0,
    ...
    angular.module('mean.socket').directive('colorpicker', ['$document', '$compile', 'Color', 'Slider', 'Helper', function ($document, $compile, Color, Slider, Helper) {
        'use strict';
        return {
            require: '?ngModel',
            restrict: 'A',
